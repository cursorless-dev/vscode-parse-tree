...
LANGUAGES = agda bash c c-sharp clojure cpp css elm go haskell html java javascript json latex markdown php python query ruby rust scala scss sparql tsx typescript yaml
