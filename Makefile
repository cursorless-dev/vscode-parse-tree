...
LANGUAGES = agda c clojure cpp css c-sharp bash go haskell html java javascript json latex markdown php python ruby rust scala scheme scss sparql tsx typescript yaml
