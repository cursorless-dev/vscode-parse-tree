...
LANGUAGES = agda c clojure cpp css c-sharp bash go haskell html java javascript json latex markdown php powershell python ruby rust scala scss sparql tsx typescript yaml
